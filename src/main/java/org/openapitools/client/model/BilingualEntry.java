 ...
 */
@JsonPropertyOrder({
  BilingualEntry.JSON_PROPERTY_CROSS_REFERENCE_MARKERS,
  BilingualEntry.JSON_PROPERTY_CROSS_REFERENCES,
  BilingualEntry.JSON_PROPERTY_ETYMOLOGIES,
  BilingualEntry.JSON_PROPERTY_GRAMMATICAL_FEATURES,
  BilingualEntry.JSON_PROPERTY_HOMOGRAPH_NUMBER,
  BilingualEntry.JSON_PROPERTY_INFLECTIONS,
  BilingualEntry.JSON_PROPERTY_NOTES,
  BilingualEntry.JSON_PROPERTY_PRONUNCIATIONS,
  BilingualEntry.JSON_PROPERTY_SENSES,
  BilingualEntry.JSON_PROPERTY_VARIANT_FORMS
})
@JsonTypeName("BilingualEntry")
